...
class Escenario():
    ...
    # generamos una nueva instancia en la que le daremos valores a todas variables del constructor con las propiedades del escenario
